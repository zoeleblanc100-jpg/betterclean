...
export default function ConditionsUtilisationPage() {
  ...
  const sections = isFr ? [
    { title: "1. Acceptation des conditions", content: "En accédant et en utilisant le site web Happy Cat Toys, vous acceptez d'être lié par ces conditions d'utilisation. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser notre site." },
    { title: "2. Description du service", content: "Happy Cat Toys est une boutique en ligne spécialisée dans la vente de jouets et accessoires pour chats. Nous proposons des produits de qualité premium, 100% canadiens, avec livraison rapide partout au Canada." },
    ...
    { title: "7. Propriété intellectuelle", content: "Tout le contenu de ce site est la propriété de Happy Cat Toys et est protégé par les lois sur le droit d'auteur. Toute reproduction non autorisée est interdite." },
    ...
    { title: "7. Intellectual Property", content: "All content on this site is the property of Happy Cat Toys and is protected by copyright laws. Any unauthorized reproduction is prohibited." },
