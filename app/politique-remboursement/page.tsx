...
export default function PolitiqueRemboursementPage() {
  ...
  const sections = isFr ? [
    { title: "1. Notre engagement", content: "Chez Happy Cat Toys, votre satisfaction est notre priorité. Nous offrons une politique de remboursement généreuse de 30 jours pour vous assurer une expérience d'achat sans souci." },
    ...
    { title: "3. Conditions de remboursement", content: "Éligibles : jouets non utilisés ou légèrement utilisés, accessoires dans leur emballage, produits défectueux, erreurs de commande. Non éligibles : produits personnalisés, jouets fortement endommagés, retours après 30 jours, articles en promotion finale." },
    { title: "4. Comment demander un remboursement", content: "Étape 1 : Contactez-nous à support@betterclean.com avec votre numéro de commande, raison du retour et photos si défectueux. Étape 2 : Retournez le produit avec l'étiquette prépayée. Étape 3 : Remboursement traité sous 3-5 jours ouvrables." },
    ...
    { title: "10. Contact", content: "support@betterclean.com | 1-800-BETTERCLEAN | Lun-Ven 9h-17h (EST). Réponse garantie sous 24h." },
  ] : [
    { title: "1. Our Commitment", content: "At Happy Cat Toys, your satisfaction is our priority. We offer a generous 30-day refund policy to ensure a worry-free shopping experience." },
    ...
    { title: "3. Refund Conditions", content: "Eligible: unused or lightly used toys, accessories in original packaging, defective products, order errors. Not eligible: custom products, heavily damaged toys, returns after 30 days, final sale items." },
    { title: "4. How to Request a Refund", content: "Step 1: Contact us at support@betterclean.com with your order number, return reason and photos if defective. Step 2: Return the product with the prepaid label. Step 3: Refund processed within 3-5 business days." },
    ...
    { title: "10. Contact", content: "support@betterclean.com | 1-800-BETTERCLEAN | Mon-Fri 9am-5pm (EST). Guaranteed response within 24h." },
  ]
